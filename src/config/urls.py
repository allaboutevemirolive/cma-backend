...
schema_view = get_schema_view(
    openapi.Info(
        ...
        default_version="v1",
        description=(
            "API for a multi-user learning platform. Allows management of Users, Profiles, "
            "Courses, Enrollments, Quizzes, Questions, Choices, and Submissions."
        ),
...
urlpatterns = [
    ...
    # Using include() to group app-specific URLs makes it cleaner
    path(
        "api/",
        include(
            [
                ...
                # Include URLs from the 'enrollments' app
                path("", include("apps.enrollments.urls")),
                # Include URLs from the 'quizzes' app
                path("", include("apps.quizzes.urls")),  # <-- Added this line
                ...
                # --- Add other app API endpoints here if needed ---
                # Example: If profiles app had its own API endpoints:

...
# Assumes you have these views defined in apps.users.views
# (CurrentUserView is optional if not used by frontend)
# from apps.users.views import CurrentUserView # Keep if needed
...
schema_view = get_schema_view(
    openapi.Info(
        ...
        # terms_of_service="https://www.example.com/policies/terms/", # Optional: Add your terms URL
        contact=openapi.Contact(
            email="api-support@example.com"  # Optional: Add your contact email
        ),
        license=openapi.License(
            name="BSD 3-Clause License"  # Optional: Specify your license
        ),
    ),
